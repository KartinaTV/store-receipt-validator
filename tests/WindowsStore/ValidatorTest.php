 ...
 * @coversNothing
 */
final class WindowsValidatorTest extends TestCase
{
    /**
    ...
    public function testValidate($receipt)
    {
        ...
        static::assertTrue($validator->validate()->isValid(), 'Receipt should validate successfully');
    }
    ...
    public function testValidateFails()
    {
        ...
        $validator = new Validator();
        $validator->setPurchaseToken('foo bar');
        $validator->validate();
    }
